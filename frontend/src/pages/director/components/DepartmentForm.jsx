...
const DepartmentForm = ({ userId }) => {
    const apiKey = 'http://127.0.0.1:8000/api/posts/store';
    const department = getArrayById(departments, 'id', userId);

    const initialState = {
        'department': userId ? department[0]['department'] : '',
    }
    ...
    return (
        <div className='px-1 space-y-2'>
            ...
            <h1 className='text-2xl font-medium'>{userId ? 'Update Department' : 'Create New Department'}</h1>
